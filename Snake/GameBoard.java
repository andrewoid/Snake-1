...
class GameBoard {
	...
	private void addEyes(Graphics2D g, String direction) {
		BufferedImage i = null;
		try {
			i = ImageIO.read(new File(direction));
		} catch (IOException e) {
			e.printStackTrace();
			;
		}
	...
	private String addLeftEyes() {
		eyes = "gifs/eyes_left.png";
		return eyes;
	}
	
	private String addUpEyes() {
		eyes = "gifs/eyes_up.png";
		return eyes;
	}
